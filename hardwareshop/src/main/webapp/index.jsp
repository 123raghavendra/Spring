...
background-image:url("https://assets.ozy.com/ozy-prod/2019/07/gettyimages451801318.jpg?width=600&height=337&fit=cover");
...
<p style="color: red;">${error}</p>
  ...
  <form  action="save" method="post" style=" text-align: center;">
      <pre>
    ShopName:      <input type="text" name="shopName" >
  
  ShopAdress:   <input type="text" name="shopAdress" >
  
       Rent:    <input type="text" name="rent" >
  
  OwnearName:  <input type="text" name="ownearName" >
  
  BrandsAvailable: <input type="text" name="brandsAvailable" > 
